---
title: "Survey protocol camau March 2020"
...
To estimate ecosystem service derived from mangrove, we will conduct structured interviews with households located in Ca Mau, especially focusing on drivers of ecosystem service. 
...
## Target
Our targets are households living in 24 communes, Ca Mau province. In 2010, a survey has been done in this region. Mangrove forests surrounding there is in danger of extinction. In terms of conservation of the mangrove and establishment of sustainable economy, understanding there is vital issue.

For 120 households located in 24 communes of Ca Mau province, we would like to perform the survey. Using Google Maps, we checked current situations of target household in 2010. Some of them have been disappeared and others still remains. Because of development such as shrimp pond, forestation, and others, they have been forced to move.
...
+ 53 households in 15 communes: The households in the communes have experienced survey in 2020. The households will be expected to "panel" data. This group includes the following communes; Dat Moi, Ham Rong, Hang Vinh, Hiep Tung, Lam Hai, Dat Mui, Rach Goc, Tan An Tay, Vien An Dong, Cai Doi Vam, Phu Tan, Rach Cheo, Tan Hung Tay, Viet Khai, and Viet Thang.
...
The predictors includes the following factors: 
...
On 16th. March, we will move from Can Tho to Ca Mau with a van. 
